...
def KLT(I, T, box_initial, p, iterations=50, epsilon=0.1, learningRate=90):
    ...
    for _ in range(iterations):
        ...
        # matrixSum = SDI.T.dot(errorImage)
        # 5. compute hessian
        H = SDI.T.dot(SDI)
    ...
    box_new = (((max(tl_new[0],br_new[0])-115), tl_new[1]), (br_new[0]-15, br_new[1]))
